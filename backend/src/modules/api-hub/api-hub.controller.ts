...
export const apiHubController = {
    ...
    async update(req: Request, res: Response) {
        try { res.json(await apiHubService.updateIntegration(req.params.id, req.body)); }
        catch (e: any) { handleError(res, e); }
    },

    async remove(req: Request, res: Response) {
        try { await apiHubService.deleteIntegration(req.params.id); res.status(204).send(); }
        catch (e: any) { handleError(res, e); }
    },
    ...
    async testConnection(req: Request, res: Response) {
        try { res.json(await apiHubService.testConnection(req.params.id)); }
        catch (e: any) { handleError(res, e); }
    },

    async triggerSync(req: Request, res: Response) {
        try { res.json(await apiHubService.triggerSync(req.params.id)); }
        catch (e: any) { handleError(res, e); }
    },

    async getSyncSummary(req: Request, res: Response) {
        try { res.json(await apiHubService.getSyncSummary(req.params.id)); }
        catch (e: any) { handleError(res, e); }
    },
    ...
    async getBuildings(req: Request, res: Response) {
        try { res.json(await apiHubService.getBuildings(req.params.id)); }
        catch (e: any) { handleError(res, e); }
    },

    async getProperties(req: Request, res: Response) {
        try { res.json(await apiHubService.getProperties(req.params.id, qNum(req.query.page), qNum(req.query.pageSize, 25))); }
        catch (e: any) { handleError(res, e); }
    },

    async getPropertyUnits(req: Request, res: Response) {
        try { res.json(await apiHubService.getPropertyUnits(req.params.id, qNum(req.query.page), qNum(req.query.pageSize, 25))); }
        catch (e: any) { handleError(res, e); }
    },
    ...
    async getTenants(req: Request, res: Response) {
        try {
            res.json(await apiHubService.getTenants(
                req.params.id, qNum(req.query.page), qNum(req.query.pageSize, 25), qStr(req.query.search)
            ));
        } catch (e: any) { handleError(res, e); }
    },

    async getOwners(req: Request, res: Response) {
        try { res.json(await apiHubService.getOwners(req.params.id, qNum(req.query.page), qNum(req.query.pageSize, 25))); }
        catch (e: any) { handleError(res, e); }
    },
    ...
    async getTenantAccountStatus(req: Request, res: Response) {
        try {
            ...
            res.json(await apiHubService.getTenantAccountStatus(req.params.id, tenantId, period));
        } catch (e: any) { handleError(res, e); }
    },
    ...
    async getTenantActiveLeases(req: Request, res: Response) {
        try {
            ...
            res.json(await apiHubService.getTenantActiveLeases(req.params.id, tenantId));
        } catch (e: any) { handleError(res, e); }
    },
    ...
    async reportIncident(req: Request, res: Response) {
        try {
            ...
            res.json(await apiHubService.reportIncidentProxy(req.params.id, { category, message, longitude, latitude }));
        } catch (e: any) { handleError(res, e); }
    },

    async getReportTypes(req: Request, res: Response) {
        try { res.json(await apiHubService.getReportTypesProxy(req.params.id)); }
        catch (e: any) { handleError(res, e); }
    },
};
